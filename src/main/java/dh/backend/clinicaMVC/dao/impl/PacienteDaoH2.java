...
import dh.backend.clinicaMVC.models.Domicilio;
...
public class PacienteDaoH2 implements IDao<Paciente> {
    ...
    private static String SQL_INSERT = "INSERT INTO PACIENTES (APELLIDO, NOMBRE, DNI, FECHA_INGRESO, DOMICILIO_ID) VALUES (?,?,?,?,?)";
